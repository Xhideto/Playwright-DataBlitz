...
class TestDatablitzFilters:
    ...
    def test_discount_rate_options_checkbox(self, page: Page):
        page.goto("https://ecommerce.datablitz.com.ph/collections/playstation-5")

        filters = page.locator('.card')

        options = filters.locator('.boost-pfs-filter-option-discount-rate .boost-pfs-filter-option-item-list li').count()
        print(f"{options}")

        for i in range(options):
            option = filters.locator('.boost-pfs-filter-option-discount-rate .boost-pfs-filter-option-item-list li').nth(i)
    ...
    def test_discount_rate_options_button(self, page: Page):
        page.goto("https://ecommerce.datablitz.com.ph/collections/playstation-5")
