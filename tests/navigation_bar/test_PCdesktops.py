...
class TestNavBarPcDesktops:
    ...
    def test_pc_desktops_recommend(self, page: Page):
        ...
        for i in range(recommend_laps):
            ...
            laps_desks = page.locator('.tmenu_submenu_tab_active .tmenu_item_layout_image').nth(i)
            expect (laps_desks.locator('.tmenu_image')).to_be_visible()

            laps_desks.locator('.tmenu_item_link').click()
    ...
    def test_pc_desktops_categories(self, page: Page):
        page.goto("https://ecommerce.datablitz.com.ph/")
        ...
        expect (pc_laps.get_by_role('tab', name="Laptops & Desktops")).to_be_visible()
        pc_laps.get_by_role('tab', name="Laptops & Desktops").hover()

        expect (pc_laps.locator('.tmenu_submenu_tab_active').get_by_role('link', name="Categories")).to_be_visible()
        pc_laps.locator('.tmenu_submenu_tab_active').get_by_role('link', name="Categories").click()
        ...
        categories1 = page.locator('#tmenu-tabpanel-tmenu-menu-899587 .tmenu_item_level_1.tmenu_col-4:has(a[title="Categories"]) .tmenu_item_level_2').count()
        categories2 = page.locator('#tmenu-tabpanel-tmenu-menu-899587 .tmenu_item_level_1.tmenu_col-4:has(a[title="Categories"]) + .tmenu_item_level_1.tmenu_col-4 .tmenu_item_level_2').count()
        categories3 = page.locator('#tmenu-tabpanel-tmenu-menu-899587 .tmenu_item_level_1.tmenu_col-4:has(a[title="Categories"]) + .tmenu_item_level_1.tmenu_col-4 + .tmenu_item_level_1.tmenu_col-4 .tmenu_item_level_2').count()
        ...
        for i in range(categories1):
            ...
            link = page.locator('#tmenu-tabpanel-tmenu-menu-899587 .tmenu_item_level_1.tmenu_col-4:has(a[title="Categories"]) .tmenu_item_level_2').nth(i)
        ...
        for i in range(categories2):
            ...
            link = page.locator('#tmenu-tabpanel-tmenu-menu-899587 .tmenu_item_level_1.tmenu_col-4:has(a[title="Categories"]) + .tmenu_item_level_1.tmenu_col-4 .tmenu_item_level_2').nth(i)
        ...
        for i in range(categories3):
            ...
            link = page.locator('#tmenu-tabpanel-tmenu-menu-899587 .tmenu_item_level_1.tmenu_col-4:has(a[title="Categories"]) + .tmenu_item_level_1.tmenu_col-4 + .tmenu_item_level_1.tmenu_col-4 .tmenu_item_level_2').nth(i)
