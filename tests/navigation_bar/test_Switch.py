...
class TestNavBarSwitch:
    ...
    def test_switch_accessories(self, page: Page):
        page.goto("https://ecommerce.datablitz.com.ph/")
        ...
        expect (switch.get_by_role('link', name="SWITCH ACCESSORIES", exact=True)).to_be_visible()

        switch.hover()
        page.wait_for_timeout(500)
        switch.get_by_role('link', name="SWITCH ACCESSORIES", exact=True).click()
        expect (page).to_have_url("https://ecommerce.datablitz.com.ph/collections/category-nintendo-switch-accessories")
        ...
        accessories1 = page.locator('.tmenu_item_level_1.tmenu_col-2:has(a[title="SWITCH ACCESSORIES"]) .tmenu_item_level_2').count()
        accessories2 = page.locator('.tmenu_item_level_1.tmenu_col-2:has(a[title="SWITCH ACCESSORIES"]) + .tmenu_item_level_1.tmenu_col-2 .tmenu_item_level_2').count()
        ...
        for i in range(accessories1):
            ...
            link = page.locator('.tmenu_item_level_1.tmenu_col-2:has(a[title="SWITCH ACCESSORIES"]) .tmenu_item_level_2').nth(i)
        ...
        for i in range(accessories2):
            ...
            link = page.locator('.tmenu_item_level_1.tmenu_col-2:has(a[title="SWITCH ACCESSORIES"]) + .tmenu_item_level_1.tmenu_col-2 .tmenu_item_level_2').nth(i)
